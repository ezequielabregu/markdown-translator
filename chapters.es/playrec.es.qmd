...
![*Estoy sentado en una habitación* design](/assets/images/play-rec/lucier-diagram.jpg)
...
! [Implementación de datos puros de Iro Sent en una habitación] (/activos/capturas de pantalla/playrec/siting.png)

En esta sección, desglosaremos el parche de datos puro [`I-am-sitting-in-a-room.pd`] (/assets/code/playrec/i-am-siting-in-a-room.pd) paso a paso. Este parche está inspirado en la pieza icónica de Alvin Lucier y demuestra cómo grabar y reproducir recursivamente el sonido para revelar las frecuencias resonantes de una habitación.
...
- Reproducir `record-B.wav` y grabarlo nuevamente, cada vez reforzando las resonancias de la habitación.
...
El parche [I-AM-Sitting-In-Aroom Freeverb.pd] (/Assets/Code/PlayRec/I-AM-Sitting-In-A-Room Freeverb.pd) extiende el concepto original*Estoy Sentado en una hábitación*introduciendo un **entorno acústico virtual** Usando la reverbra y permitiendo **entrada entrada pregrabada** en lugar de solo microfonos en lugar de la entrada. Esta adaptación proporciona una flexibilidad más creativa y resultados consistentes en comparación con el uso de una habitación física.

! [Implementación de datos puros de estoy sentado en una habitación con Freeverb] (/Assets/Screenshots/PlayRec/Sitting Freeverb.png)
...
- `s~/r~ player.B` - enruta la reproducción de la reproducción del archivo B al grabador A
